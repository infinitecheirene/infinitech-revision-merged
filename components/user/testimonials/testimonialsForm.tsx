...
const TestimonialForm = () => {
  return (
    <div className="mx-auto mt-4 p-6 flex justify-center flex-col">
      <div className="max-w-2xl text-center mx-auto">
        <h2 className="text-2xl sm:text-3xl font-['Poetsen_One'] text-primary text-center mb-4 sm:mb-6">Share Your Experience</h2>
        <p className="mb-4 md:px-6 sm:mb-6 text-sm md:text-base mx-auto text-gray-700 text-left">
          We’d love to hear your thoughts! Your feedback helps us grow and inspires others to trust our services.
        </p>
      </div>
      <div className="w-full max-w-2xl mx-auto mt-4 p-6 sm:p-8 rounded-2xl shadow-lg">
